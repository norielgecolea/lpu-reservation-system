...
@Component({
  ...
  imports: [ RouterLink, UiButton, UiIcon, UiInputSearch, UiSelect, UiToast, UiDateSelector, GymnasiumRescheduleCalendar, GymnasiumCoordinationCalendar, MaintenanceCalendarPicker, ReservationExportModal, ApprovedReservationActionsMenu, ReservationApproverTableSkeleton, ReservationApproverMobileSkeleton, DashboardEventSummaryModal],
                    ...
                    <div class="flex items-start justify-between gap-3">
                      <div class="min-w-0 flex-1">
                        ...
                        @if (row.numberOfAttendees) {
                          <p class="text-xs text-gray-500">{{ row.numberOfAttendees }} attendees</p>
                        }
                      </div>
                      <span
