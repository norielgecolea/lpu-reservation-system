...
@Component({
  selector: 'app-gymnasium-edit-details-modal',
...
export class GymnasiumEditDetailsModal {
  readonly reservation = input.required<GymReservationRecord>();
  readonly saving = input(false);
  readonly saved = output<GymnasiumReservationDetailsEditRequest>();
